...
- não começar com numéros
- não utilizar espaços
- ter nome significativo
- manter nome em minúsculo
- quando for palavra composta, colocar as iniciais a partir da segunda palavra em maiúsculo
- o js diferencia minúsculo e MAIÚSCULAS (case sensitive)
...
numérico 10
    ...
    + --> adição quando é so com números
*/
